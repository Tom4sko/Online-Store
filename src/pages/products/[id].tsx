...
const productPage = () => {
  ...
  return (
    <main className="flex flex-col bg-primary min-h-screen w-screen px-2 md:px-10">
      <button type="button" onClick={goBack} className="flex justify-center items-center align-middle w-40 h-12 bg-secondary text-primary gap-2 my-6">Go Back<FaLongArrowAltRight /></button>
      <div className="flex flex-col-reverse md:flex-row w-full gap-12">
        ...
        <div className="flex flex-col w-full items-start gap-2">
          ...
          <button type="button" className="flex justify-center items-center align-middle w-40 h-12 bg-secondary text-primary gap-2 my-6">Buy Now!</button>
        </div>
      </div>
    </main>
  )
